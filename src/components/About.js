...
export default function About() {
  return (
    <section className="my-20" id="about">
      <div className="container mx-auto px-10 mx-10 md:pb-20 flex items-center justify-between">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <a href="https://www.linkedin.com/in/tyler-hooks-9214abb5" className="w-5 mr-4">
            <img
              src={Linkedin}
            />
          </a>
          <a href="https://github.com/tylerhooks1" className="w-5">
            <img
              src={Github}
            />
          </a>
          </div>
          <p className="mb-8 leading-relaxed lg:w-2/3 mb-2">
          ...
          <p className="mb-8 leading-relaxed lg:w-2/3">
        ...
        <div className="hidden md:block lg:max-w-xl lg:w-full md:w-1/2 w-5/6">
          <img
            src={Hero}
          />
        </div>
